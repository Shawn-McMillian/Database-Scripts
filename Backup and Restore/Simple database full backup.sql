...
*******************************************************************************
**
** Script Name: Simple database full backup
**
** Created By:  Shawn McMillian
**
** Description: Perform a simple database backup, using the default settings
**
** Databases:   master
**
** Revision History:
...
** ---------------------------- ----------------------- -------------------------------------------------
** 12/12/2016					Shawn McMillian			Initial script creation.
*******************************************************************************
** 
*******************************************************************************
*/
...
SET @Test = 0 --Change to 0 (zero) to take the backup.
